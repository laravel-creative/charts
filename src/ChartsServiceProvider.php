...
class ChartsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__.'/../config/laravel-creative-charts.php' => config_path('laravel-creative-charts.php'),
        ], 'charts_config');
        ...
        $this->app->register('LaravelCreative\\Support\\SupportServiceProvider');
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/laravel-creative-charts.php', 'charts');
